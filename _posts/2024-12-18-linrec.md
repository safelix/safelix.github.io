...
<div class="row mt-3">
    <div class="col-xl mt-3 mt-xl-0">
      {% include figure.liquid path="assets/img/2024-12-18-linrec/GA100-arch.png" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-md-center">
    <div class="col-6 mt-3 mt-sm-0">
      {% include figure.liquid path="assets/img/2024-12-18-linrec/GA100-sm.png" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-md-center" style="margin-bottom: 0px">
    <div class="col-xl mt-3 mt-sm-0">
      {% include figure.liquid path="assets/img/2024-12-18-linrec/bench.png" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-md-center">
    <div class="col-xl mt-3 mt-sm-0">
      {% include figure.liquid path="assets/img/2024-12-18-linrec/hw_scaling.png" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
In conclusion, linear recursions present a simple mathematical object with surprising modeling expressivity and computational opportunities. These properties make them an interesting subject of study for areas of deep learning. We hope that this blog post lowers the entry bar and sparks the interest to pursue research on linear-time sequence mixing.